...
Explorer is an enterprise search application that supports collecting, and searching across data from different sources. You need a license to run the application. 

NOTE: tl;dr - visit the <<start#,getting started section>>.

These are the core concepts of Explorer:

* <<admin/fields#, Fields>> represent a common set of fields across different sources
