...
An exciting feature of Explorer is that you may also build your own collectors. We prepared a dedicated https://developer.enonic.com/learn/building-custom-collectors[starter-kit and tutorial for building custom collectors] to give you a flying start.
