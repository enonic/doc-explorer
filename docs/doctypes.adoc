...
+
Visit the Enonic XP https://developer.enonic.com/docs/code/stable/storage/properties#value_types[Value types] documentation for more details on value types and indexing.
