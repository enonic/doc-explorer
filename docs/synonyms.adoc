...
* https://developer.enonic.com/docs/code/stable/storage/indexing#languages

And some documentation on how it works:

* https://developer.enonic.com/docs/code/stable/storage/indexing#stemming
* https://developer.enonic.com/docs/code/stable/storage/querying#query_dsl
* https://developer.enonic.com/docs/code/stable/storage/noql#stemmed
